...
public class ReleaseActivity extends BaseActivity {
    ...
    private void saveEventData() {
        try {
            ...
            String formatEventDate = Utility.formatDate(eventDate);
            String formatEventStartTime = Utility.formatTime(eventStartTime);
            String formatEventEndTime = Utility.formatTime(eventEndTime);
            ...
            // convert event date to timestamp so that it would be easy to retrieve
